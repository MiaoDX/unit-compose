...
write_demo_page \
    lidar-slam \
    "LiDAR SLAM" \
    "Slamwich over a deterministic 480-frame figure-eight episode with odometry drift, a verified loop closure, and evaluation reference." \
...
<main>
  <div class="demo-list">
    ...
    <section class="demo-row"><div><span class="status">PASS</span><h2>LiDAR SLAM</h2></div><p>Large figure-eight route, persistent Slamwich state, a verified loop closure, optimized pose graph, and 480 measured frames.</p><a class="command primary" href="lidar-slam/">View report</a></section>
  </div>
</main>
